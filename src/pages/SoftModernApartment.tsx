...
const galleryImages = [
  { src: bedroom1, caption: { en: 'Soft modern bedroom with neutral tones', ru: 'Мягкая современная спальня в нейтральных тонах' } },
  { src: kitchenDining, caption: { en: 'Minimalist kitchen and dining area', ru: 'Минималистичная кухня и столовая' } },
  { src: living1, caption: { en: 'Living space with natural light and warm textures', ru: 'Гостиная с естественным светом и тёплыми текстурами' } },
  { src: living2, caption: { en: 'Open living area with contemporary details', ru: 'Открытая гостиная с современными деталями' } },
  { src: bathroom1, caption: { en: 'Functional bathroom with clean detailing', ru: 'Функциональная ванная с чистыми деталями' } },
  { src: bedroom2, caption: { en: 'Master bedroom with integrated workspace', ru: 'Главная спальня со встроенной рабочей зоной' } },
  { src: bedroom3, caption: { en: 'Bedroom with soft textiles and warm wood', ru: 'Спальня с мягким текстилем и тёплым деревом' } },
  { src: hallway, caption: { en: 'Hallway with decorative shelving and natural light', ru: 'Прихожая с декоративными полками и естественным светом' } },
  { src: bathroom2, caption: { en: 'Modern bathroom with patterned floor tiles', ru: 'Современная ванная с узорчатым полом' } },
  { src: kitchenOpen, caption: { en: 'Open kitchen with abundant natural light', ru: 'Открытая кухня с обилием естественного света' } },
];
  ...
  return (
    <PageTransition>
      <SEO
        ...
        url="https://gauhar.lovable.app/residential/soft-modern-apartment"
      />
      <Navigation />

      {/* Hero Section */}
      <section className="relative min-h-[70vh] flex items-end" style={{ backgroundColor: '#F5F3F0' }}>
        ...
        <div className="relative z-10 w-full px-6 md:px-12 lg:px-20 pb-16 md:pb-24">
          ...
          >
            ...
            <div className="flex items-center gap-6 text-white/80 text-sm tracking-wide">
      ...
      {/* Description Section */}
      <section className="py-20 md:py-32 px-6 md:px-12 lg:px-20" style={{ backgroundColor: '#F5F3F0' }}>
        <motion.div
          initial={{ opacity: 0, y: 30 }}
      ...
      {/* Gallery Grid */}
      <section className="px-4 md:px-8 lg:px-12 pb-20 md:pb-32" style={{ backgroundColor: '#F5F3F0' }}>
